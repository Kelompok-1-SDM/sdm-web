...
@else
    <form action="{{ url('/manajemen/' . $manajemen['userId'] . '/update_ajax') }}" method="POST" id="form-edit">
        @csrf
        @method('POST')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="role" value="manajemen">
                    <div class="form-group">
                        <label>Nip</label>
                        <input value="{{ $manajemen['nip'] }}" type="number" name="nip" id="nip"
                            class="form-control">
                        <small id="error-nip" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Nama</label>
                        <input value="{{ $manajemen['nama'] }}" type="text" name="nama" id="nama"
                            class="form-control">
                        <small id="error-nama" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input value="{{ $manajemen['email'] }}" type="email" name="email" id="email"
                            class="form-control">
