...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction('{{ url('admin/' . $admin['userId'] . '/edit_ajax') }}')"
                    class="btn btn-sm btn-warning mt-1">Edit</button>
                <button onclick="modalAction('{{ url('admin/' . $admin['userId'] . '/delete_ajax') }}')"
        ...
        <div class="card-body">
            ...
            <div class="row">
                @foreach ($admin['kompetensi'] as $apalah)
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Kegiatan pada admin</h3>
        </div>
        <div class="card-body">
