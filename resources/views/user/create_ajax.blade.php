<<<<<<< HEAD:resources/views/admin/create_ajax.blade.php
<form action="{{ url('/admin/store_ajax') }}" method="POST" id="form-tambah">
=======
<form action="{{ url('/' . $userType . '/store_ajax') }}" method="POST" id="form-tambah">
>>>>>>> 24444c93d92e7571389c3cf7db92cf1f91e5f3c5:resources/views/user/create_ajax.blade.php
    @csrf
