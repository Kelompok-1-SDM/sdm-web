...
class AdminController extends Controller
{
    ...
    public function export_excel()
    {
        ...
        if ($response->successful()) {
            ...
            $fileName = "admin_" . date('Y-m-d H:i:s') . ".xlsx";
    ...
    public function confirm_ajax(string $id)
    {
        ...
        if ($response->successful()) {
            return view('admin.confirm_ajax', ['admin' => $response->json('data')]);
        } else {
            return view('admin.confirm_ajax', ['admin' => null]);
        }
    }
    ...
    public function edit_ajax(string $id)
    {
        ...
        if ($response->successful()) {
            return view('admin.edit_ajax', ['admin' => $response->json('data')]);
        } else {
            return view('admin.edit_ajax', ['admin' => null]);
        }
    }
